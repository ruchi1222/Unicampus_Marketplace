...
<xsl:template match="/">
    ...
    <head>
        <meta charset="UTF-8"/>
        <title>UniMart Catalog</title>
        <link rel="stylesheet" href="csstrial.css"/>
    </head>
    <body style="background-color: #fdf0f5; font-family: sans-serif;"> 
        <section class="categories">
            <h1 style="text-align: center; padding: 20px; color: #e91e63;">UniMart Catalog</h1>
            <hr style="width: 80%; margin: auto; border: 1px solid #e91e63;"/>
            ...
            <div class="category-section">
                ...
                <div class="shop__container" style="display: flex; flex-wrap: wrap; justify-content: center;">
                    <xsl:for-each select="main:unimart/main:product[@category='books']">
            ...
            <div class="category-section">
                ...
                <div class="shop__container" style="display: flex; flex-wrap: wrap; justify-content: center;">
                    <xsl:for-each select="main:unimart/main:product[@category='stationaries']">
                        <xsl:call-template name="product-card"/>
                    </xsl:for-each>
                </div>
            </div>
            ...
            <div class="category-section">
                ...
                <div class="shop__container" style="display: flex; flex-wrap: wrap; justify-content: center;">
                    <xsl:for-each select="main:unimart/main:product[@category='tech']">
                        <xsl:call-template name="product-card"/>
                    </xsl:for-each>
                </div>
            </div>
    ...
    <article class="shop__card" style="background: white; border-radius: 10px; padding: 15px; margin: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); text-align: center; width: 250px;">
        ...
        <div class="shop__box">
            <img class="shop__img" style="width: 100%; height: 180px; object-fit: contain;">
                <xsl:attribute name="src">
                    <xsl:value-of select="main:image"/>
                </xsl:attribute>
            </img>
        </div>
        <div class="shop__details" style="margin-top: 10px;">
            <p class="shop__description" style="font-size: 0.9rem; color: #666; height: 40px; overflow: hidden;">
                <xsl:value-of select="main:description"/>
            </p>
            <div class="shop__price" style="color: #e91e63; font-weight: bold; margin: 10px 0;">
                Rs <xsl:value-of select="main:price"/>
            </div>
            <button class="btn" style="background-color: #f06292; color: white; border: none; padding: 8px 15px; border-radius: 5px; cursor: pointer;">
                Add To Cart
            </button>
        </div>
    </article>
